...
import { BottomLine, MySkill } from "../../components";
    ...
    <div className="parent pt-16 my-16">
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          >
            <img
              src="https://res.cloudinary.com/diiekahnn/image/upload/v1728928199/Black_And_Gold_Simple_Depop_Profile_Picture_en4zay.png"
              alt="Ahmad Majid"
          ...
          >
            <h1 className="text-4xl font-semibold mb-4 text-center translate-y-[-380%] sm:translate-y-[-0%] sm:text-3xl sm:mb-2 md:text-left">Ahmad Majid</h1>
            <div className="my-8">
              <TypeAnimation
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ">
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Name : </span>Ahmad Majid
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Phone : </span>+92 3476903990
              </h2>
              <h2 className="font-medium">
              ...
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Address : </span>Lahore, Pakistan
              </h2>
              <a
                href="https://drive.google.com/file/d/1i6hg074h3IwRf-4fkHr_SenPuHC0Zlhl/view?usp=drive_link"
                target="blank"
              >
