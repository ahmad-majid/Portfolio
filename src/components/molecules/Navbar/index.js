  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <h1 className="text-2xl text-primary font-lobster">Ahmad Majid</h1>
          </Link>
        </div>
        <div>
          <ul className="lg:flex items-center hidden">
            ...
            <a
              ...
              href="https://drive.google.com/file/d/1i6hg074h3IwRf-4fkHr_SenPuHC0Zlhl/view"
              target="blank"
            >
              <PrimaryBtn>
                <span>Resume</span>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-neutral">
                  &copy; Copyright 2023, Ahmad Majid. All Rights Reserved
                </p>
              </div>
            </Drawer>
          </div>
